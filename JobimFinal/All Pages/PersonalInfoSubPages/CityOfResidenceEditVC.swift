...
class CityOfResidenceEditVC: SimpleViewController, UINavigationBarDelegate ,UITableViewDelegate, UITableViewDataSource, userDataDelegate{
...
override func viewDidLoad() {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            break
        case 1:
            city = UITextField(frame: CGRect(x: 20, y: 0 , width: cell.frame.width - 40, height: cell.frame.height ))
            city.backgroundColor = UtilityService.cnfg.BrandLightGray
            city.layer.cornerRadius = 5
            city.textAlignment = .right
            city.rightViewMode = .always
            city.rightView = UIView(frame: CGRect(x: 0, y: 0, width: 20, height: city.frame.height))
            city.textColor = UtilityService.cnfg.BrandOrange
    ...
    func onUserDataUpdated(_ userData: UserData) {
        city.text = AppDataService.userRepository.cityOfResidence
    }
    ...
    @objc func saveChoice () {
        AppDataService.userRepository.cityOfResidence = city.text
    ...
    func configNavBar(){
        ...
        navItem.title = "עריכת עיר מגורים"
